...
#paddles_url = 'http://localhost/nodes/'
paddles_url = 'http://localhost/paddles/'

machine_type = 'tnode'
lab_domain = 'gluesys.com'
...
def main():
    ...
    for fqdn in fqdns:
        ...
        base_info = dict(
            ...
            locked_by='teuthworker@teuthology-c1',
